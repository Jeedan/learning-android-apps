...
public class ShowDatabase {
	...
	private JSONSerializer mSerializer;  // save tracked shows
	...
	private ShowDatabase(Context context){
		mAppContext = context;
		mSerializer = new JSONSerializer(mAppContext, FILENAME_SAVE_TRACKED);
 ...
 * 
	...
	// not used, got all epiguides episodes for a show
